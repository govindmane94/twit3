...
if(isset($_POST['title'], $_POST['recip'], $_POST['message']))
{
	...
	if($_POST['title']!='' and $_POST['recip']!='' and $_POST['message']!='')
	{
		...
		$dn1 = mysql_fetch_array(mysql_query("select count(id) as recip, id as recipid, (select count(*) from pm) as npm from users where username='".$recip."' group by username"));
		if($dn1['recip']==1)
		{
...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Home</a> &gt; <a href="list_pm.php">List of you PMs</a> &gt; New PM
    </div>
	<div class="box_right">
