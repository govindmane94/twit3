...
{
	$dn1 = mysql_fetch_array(mysql_query("select count(c.id) as nb1, c.name from categories as c where c.id='".$id."' GROUP BY c.id"));
if($dn1['nb1']>0)
{
?>
<html>
...
if(isset($_POST['message'], $_POST['title']) and $_POST['message']!='' and $_POST['title']!='')
{
	...
	<a href="list_topics.php?parent=<?php echo $id; ?>">Go to the Home</a></div>
	<?php
	}
	else
	{
