...
<html>
    <head>
        ...
        <title>Delete a category - <?php echo htmlentities($dn1['name'], ENT_QUOTES, 'UTF-8'); ?> - Home</title>
    </head>
    <body>
    	<div class="header">
...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Home</a> &gt; <?php echo htmlentities($dn1['name'], ENT_QUOTES, 'UTF-8'); ?> &gt; Delete the category
    </div>
	<div class="box_right">
...
if(isset($_POST['confirm']))
{
	...
	<a href="<?php echo $url_home; ?>">Go to the Home</a></div>
	<?php
	}
	else
	{
